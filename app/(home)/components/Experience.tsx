...
const Experience: React.FC = () => {
  ...
  return (
    <div className="pt-16 pb-10">
      <h2 className="font-bold text-6xl mt-8 mb-32 w-full text-center text-accent">
        Experience
      </h2>
      ...
      >
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4">
          <Details
            ...
            address="Toronto, ON"
            work="Contributed in a Jyutping-to-Chinese transliteration project, focusing on data analysis, sourcing, and cleaning for an
            RNN model, achieved a character error rate (CER) of 0.21
            • Developed Python scripts to automate repetitive tasks and data entry process with PyCantonese and ELAN API on
            63 Cantonese interview transcriptions
          ...
          <Details
            ...
            address="Toronto, ON"
            work="Developed a web scraping mechanism in Python to scrape industrial policies and patenting data from PKUlaw.com
